...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    {
      List<WebElement> elements = driver
          .findElements(By.xpath("//a[text()=\'Reset\' and contains(@href, \'/reset\')]"));
  ...
  public void tEST7RETURN() {
    driver.get("http://localhost:8080");
    js.executeScript(
        "document.cookie = \"1=false\";document.cookie = \"2=true\";document.cookie = \"3=false\";location.reload();");
    driver.findElement(By.linkText("Rent-A-Cat")).click();
  ...
  public void tEST10GREETACAT() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//html[contains(.,\'Meow!Meow!Meow!\')]"));
      assert (elements.size() > 0);
    }
  }
  ...
  public void tEST11GREETACATWITHNAME() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//html[contains(.,\'Meow! from Jennyanydots.\')]"));
      assert (elements.size() > 0);
    }
  }
